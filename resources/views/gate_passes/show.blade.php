        ...
        <div class="row align-items-center d-print-none">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    ...
                    @endif
                    <form action="{{ route('gate-passes.destroy', $gatePass) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Gate Pass? This will also remove any linked financial transaction.')" class="d-inline">
                        @csrf
                        @method('DELETE')
