<x-tabler-layout>
    <x-slot name="header">
        <div class="row align-items-center mb-3">
            <div class="col">
                ...
                <h2 class="page-title h1 fw-bold">Crusher Operations</h2>
            </div>
    ...
    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('crusher.index') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-4">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center py-3 bg-transparent">
                    <h3 class="card-title fw-bold">Crusher Records</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('operations.tags.store', $unit) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="e.g. Metal Sale Grade A" required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content border-0 shadow-lg">
                <form action="{{ route('operations.records.store', $unit) }}" method="POST">
                    ...
                    <div class="modal-header bg-dark text-white py-3 border-0">
                        <h5 class="modal-title fw-bold">Add Operational Record - Crusher</h5>
