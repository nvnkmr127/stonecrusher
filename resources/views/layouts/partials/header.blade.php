<header class="navbar navbar-expand-md d-print-none border-bottom-0" style="min-height: 4rem; background: rgba(255,255,255,0.8); backdrop-filter: blur(4px);">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0 align-items-center" data-bs-toggle="dropdown"
                    ...
                    <div class="d-none d-xl-block ps-2 text-start">
                        ...
                        <div class="small text-muted" style="margin-top: -2px;">{{ Auth::user()?->roles->pluck('name')->implode(', ') ?? 'Guest' }}</div>
                    </div>
                </a>
