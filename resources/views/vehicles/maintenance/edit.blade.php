<x-tabler-layout>
    <x-slot name="header">
        <x-page-header title="Edit Maintenance Record" subtitle="Update repair or service history" :breadcrumbs="[
    ...
    <div class="row row-cards">
        <div class="col-md-8 mx-auto">
            <x-card>
                <form action="{{ route('vehicle-maintenance.update', $vehicle_maintenance) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="date"
                                    value="{{ old('date', $vehicle_maintenance->date->format('Y-m-d')) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="completion_date"
                                    value="{{ old('completion_date', $vehicle_maintenance->completion_date?->format('Y-m-d')) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="vehicle_id" class="form-select @error('vehicle_id') is-invalid @enderror"
                                    ...
                                    @foreach($vehicles as $vehicle)
                                        <option value="{{ $vehicle->id }}" {{ old('vehicle_id', $vehicle_maintenance->vehicle_id) == $vehicle->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror"
                                    ...
                                    @foreach($statuses as $status)
                                        <option value="{{ $status }}" {{ old('status', $vehicle_maintenance->status) == $status ? 'selected' : '' }}>{{ $status }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                    ...
                                    @foreach($types as $type)
                                        <option value="{{ $type }}" {{ old('type', $vehicle_maintenance->type) == $type ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="cost"
                                    value="{{ old('cost', $vehicle_maintenance->cost) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="odometer_reading"
                                    value="{{ old('odometer_reading', $vehicle_maintenance->odometer_reading) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="workshop_name"
                                    value="{{ old('workshop_name', $vehicle_maintenance->workshop_name) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="description" rows="4"
                                    ...
                                    placeholder="List parts changed or repairs made...">{{ old('description', $vehicle_maintenance->description) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="performed_by"
                                    value="{{ old('performed_by', $vehicle_maintenance->performed_by) }}"
                    ...
                    <div class="card-footer text-end">
                        <div class="d-flex">
                            ...
                            <button type="submit" class="btn btn-primary ms-auto">Update Record</button>
                        </div>
                    </div>
                </form>
            </x-card>
